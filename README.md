...
| Shift   | Sprint — drains stamina, and the Passenger can hear you farther away |
| Space   | Jump                                            |
| F       | Flashlight                                      |
...
- A playable evening before the night: an apartment with working fixtures, neighbors on the street, and a short scripted commute — the car pulls out of the side street, drives east along Mountain Route Seventeen past the bus shelter and the shuttered diner, and turns in under the station canopy, camera at dashboard height the whole way.
...
- Powered sliding entrance with proximity sensor and a wall-mounted lock panel; swinging interior doors; repairable rear latch.
- The security alarm is a thing people hear: ring it with a customer in the shop and they answer in character — Emi rattled, Daichi invoking depot drills, Mrs. Hasegawa almost saying what it reminds her of, Ryo begging you not to call anything closer. Kuroda telephones about false alarms. Two customers do not react at all, and noticing that is written to the journal.
- Condition and stamina bars: sprinting drains stamina and running dry means walking until you catch your breath — which matters, because sprinting is what the Passenger hears. Space jumps, at a small stamina cost.
...
- Between customers the night hands out real maintenance: mopping rainwater tracked across the tiles, refilling a shelf row from a stock carton on the workbench, and carrying the counter rubbish bag out through the rear door to the yard bin. Chores use the same carry and interaction machinery as the story, wait politely while a customer is at the till, and the trash run deliberately walks the route past the loose rear latch.
